...
| 포맷 | 주요 옵션 |
|------|----------|
| [배너](./02-formats.md#배너-banner) | 캐러셀, 인디케이터, 롤링 시간 |
| [스플래시](./02-formats.md#스플래시-splash) | 노출 시간, 배경색 |
| [팝업](./02-formats.md#팝업-popup) | 템플릿, 닫기 옵션, 캐러셀 |
| [네이티브](./02-formats.md#네이티브-native) | CTA 버튼, 광고주 프로필, 텍스트 항목 |
| [전면](./02-formats.md#전면-interstitial) | 닫기 버튼 지연 시간 |
| [보상형](./02-formats.md#보상형-rewarded) | 보상 콜백 |
