...
**Q. 기본 프로퍼티만으로도 타겟팅을 시작할 수 있나요?**

A. 네, 국가, 언어, 나이, 성별 같은 기본 프로퍼티로 바로 시작할 수 있습니다. 이후 서비스 고유의 커스텀 프로퍼티(회원 등급, 구매 이력, 관심사 등)를 추가하면 경쟁사와 차별화된 프리미엄 타겟팅을 만들 수 있습니다.

**Q. 카테고리를 너무 세분화하면 문제가 있나요?**

A. 카테고리가 세분화될수록 해당되는 오디언스 규모가 작아집니다. 규모가 너무 작으면 광고주가 선택하지 않거나 광고 노출이 충분히 이뤄지지 않을 수 있습니다. 광고주에게 의미 있는 규모와 정교함 사이의 균형을 찾으세요.

**Q. 카테고리를 세분화했는데 오디언스 규모가 너무 작아요.**

A. 카테고리 그룹 기능을 활용하세요. 개별 카테고리의 모수가 작더라도 관련 카테고리를 그룹으로 묶으면 광고주에게 의미 있는 규모로 제공할 수 있습니다. 예를 들어 "부산 신규 유저", "제주 신규 유저"를 "해안 신규 유저"로 묶어 판매할 수 있습니다.
